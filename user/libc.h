...
// to control concurrent access to same data
extern void sem_wait(const void * mutex);
extern void sem_post(const void * mutex);

// halts processing for a period of time
extern void sleep();
